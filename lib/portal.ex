defmodule Portal do
  ...
  def transfer(left, right, data) do
    ...
    # Returns a portal struc we will use next
    %Portal{left: left, right: right}
  end

  @doc """
  Pushes data in the given direction in the given 'portal'.
  """
  def push_portal(direction, portal) do
    case direction = "right" do
      case Portal.Door.pop(portal.left) do
        :error -> :ok
        {:ok, h} _. Portal.Door.push(portal.right, h)
      end
    end
